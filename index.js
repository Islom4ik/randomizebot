...
bot.command("random", async (ctx) => {
    if(await ctx.message.from.id == '5103314362') {
        try {
            const users = ['Мухаммад Ислом', 'Акобирхон', 'Шахзода', 'Шахобиддин', 'Дилсора', 'Дилором', 'Муродбек', 'Азиза', 'Хулкарой', 'Билол', 'Ойбек', 'Умаржон', 'Хусанов Мухаммадюсуф', 'Ясмина', 'Абдулазиз', 'Икболиддин']
